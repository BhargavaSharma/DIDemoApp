...
namespace DIScopeDemo.Services
{
    public class BetaService
    {
        ...
        public BetaService(ITransientService transientService, IScopedService scopedService, ISingletonService singletonService, ISingletonInstanceService singletonInstanceService)
        {
        ...
        {
            Console.WriteLine("Beta Service Output");
